...
public class Level implements Serializable {
    ...
    public MyImage resimler [][]; //= new int[8][8];//orjinal resimler -- cozum degerleri
    private FKaristir karistirma_islemleri;
    public MyImage [][] karistirilmis_resimler;//puzzle i olusturan resimler
    ...
    public MyImage[][] get_karistirilmis_resimler(){
        return this.karistirilmis_resimler;
    }
    
    public MyImage[][] get_cozum_resimler(){
        return this.resimler;
    }


    public void set_cozum_resimler(MyImage [][] resim){
        this.resimler=resim;
    }


    public Level(int puan, Date baslangic_tarihi, MyImage[][] resimle){
        this.puan=puan;
        this.baslangic_tarihi=baslangic_tarihi;
        
        this.resimler=resimle;



        this.karistirilmis_resimler=new MyImage [resimle.length][resimle.length];
        
        this.satir=this.sutun=resimle.length;
    ...
    public void set_karistirilmis_resimler(MyImage [][] resi){
        this.karistirilmis_resimler=resi;
    }
}